...
export const NEWS: NewsItem[] = [
...

  {
    ...
    dek: "22 Sep. New GPT-6 mid and cheap seats. AA Sol 48 / Luna 37 and Arena Sol 1509 filled 22 Sep; Luna Arena / both CB / TB / SWE still blank.",
    pull: "Fill gpt-6-sol AA 48 + arena-elo 1509; gpt-6-luna AA 37. Leave Luna Arena, both CursorBench / TB / SWE blank. Keep 5.6 Sol/Luna rows.",
    summary:
      "22 September 2026: OpenAI expands the GPT-6 universe with GPT-6 Sol and GPT-6 Luna, trained with similar methods to GPT-6 Astra for faster and cheaper work at scale. API prices drop 50% versus GPT-5.6 promotional pricing: Sol $2/$10 (from $4/$20), Luna $0.10/$0.50 (from $0.20/$1.20). Available in ChatGPT Work and Codex; Free/Go get Luna on desktop; API ids gpt-6-sol and gpt-6-luna. Same-day fills: AA Intelligence Index Sol 48 / Luna 37, and Arena+ Elo Sol 1509 (distinct OpenLM row from GPT-5.6 Sol). Luna Arena, both CursorBench, TB 2.1, and SWE stay blank. Do not mix with gpt-5.6-sol / gpt-5.6-luna or paste vendor AutomationBench / DeepSWE / OSWorld onto Ridge columns.",
    date: "2026-09-22",
    sourceName: "OpenAI",
    ...
    body: [
      ...
      "Board fills 22 Sep: AA Sol 48 / Luna 37 (Artificial Analysis model pages); Arena+ Sol 1509 (OpenLM). Luna Arena, CursorBench for both, TB 2.1, and SWE stay blank. DeepSWE and AutomationBench are not Ridge columns.",
