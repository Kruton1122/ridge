...
export const NEWS: NewsItem[] = [
  {
    ...
    dek: "Sep 12 essay: slow capability gains so safety can keep up. Not a halt. Anthropic commits to embedded evaluators; OpenAI will match.",
    pull: "Policy beat, not a board move. If pacing sticks, cadence stories slow; evaluators mean more incident notes, not AA points. Same-day: Musk agrees while xAI races Grok 4.7; Altman says OpenAI will match embedded access.",
    summary:
      "12 September: Dario Amodei argues for pacing frontier capability so alignment and eval can catch RSI and agent-swarm risk. Musk quote-tweets: \"Dario is right.\" Altman agrees on pacing and says OpenAI will also commit to independent evaluators with employee-like access. Anthropic went first; industry and global steps remain the hard part.",
    date: "2026-09-12",
