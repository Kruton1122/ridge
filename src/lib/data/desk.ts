...
export const NEWS: NewsItem[] = [
...

  {
    ...
    dek: "22 Sep. First Claude 5.5 family model. $4/$20 list. AA 58, CB 57.8, Arena 1532, TB 2.1 87.64 filled 22 Sep; SWE still blank.",
    pull: "Fill claude-opus-5.5 AA 58, cursor-bench 57.8, arena-elo 1532, terminal-bench 87.64. Leave swe blank. Do not paste vendor TB 4.0.",
    summary:
      "22 September 2026: Anthropic ships Claude Opus 5.5, the first Claude 5.5 family model. It says the cut performs at Claude Fable 5.1 level on most work and costs about 40% less than Opus 5 on typical workloads. List is $4 in / $20 out with cache reads at $0.20. Fast mode is $8/$40. API id claude-opus-5-5. Pre-release testing named Frontier Design and METR. Same-day first-party fills: AA Intelligence Index 58, CursorBench 4.0 57.8 (cursor.com), Arena+ Elo 1532, and Vals Terminal-Bench 2.1 87.64 (high, #1). SWE stays blank. Vendor Terminal-Bench 4.0 66.4% remains launch context only (not board TB 2.1).",
    date: "2026-09-22",
    ...
    body: [
      ...
      "Board fills 22 Sep: AA 58 (Artificial Analysis model page), CursorBench 57.8 (cursor.com), Arena+ 1532 (OpenLM), Terminal-Bench 2.1 87.64 (Vals, high, #1; 26/267 tasks used Opus 5 / Opus 4.8 fallbacks; fallbacks-as-fail 79.77). SWE blank. Vendor TB 4.0 66.4% is not board TB 2.1.",
...

  {
    ...
    dek: "22 Sep. New GPT-6 mid and cheap seats. AA Sol 48 / Luna 37 and Arena Sol 1509 filled 22 Sep. Vals TB 2.1 fills 23 Sep: Sol 83.15, Luna 73.03. Luna Arena / both CB / SWE still blank.",
    pull: "Fill gpt-6-sol AA 48 + arena-elo 1509 + terminal-bench 83.15; gpt-6-luna AA 37 + terminal-bench 73.03. Leave Luna Arena, both CursorBench / SWE blank. Keep 5.6 Sol/Luna rows.",
    summary:
      "22 September 2026: OpenAI expands the GPT-6 universe with GPT-6 Sol and GPT-6 Luna, trained with similar methods to GPT-6 Astra for faster and cheaper work at scale. API prices drop 50% versus GPT-5.6 promotional pricing: Sol $2/$10 (from $4/$20), Luna $0.10/$0.50 (from $0.20/$1.20). Available in ChatGPT Work and Codex; Free/Go get Luna on desktop; API ids gpt-6-sol and gpt-6-luna. Same-day fills: AA Intelligence Index Sol 48 / Luna 37, and Arena+ Elo Sol 1509 (distinct OpenLM row from GPT-5.6 Sol). Next-day Vals fills Terminal-Bench 2.1 at Sol 83.15 and Luna 73.03 (max effort). Luna Arena, both CursorBench, and SWE stay blank. Do not mix with gpt-5.6-sol / gpt-5.6-luna or paste vendor AutomationBench / DeepSWE / OSWorld onto Ridge columns.",
    date: "2026-09-22",
    sourceName: "OpenAI",
    ...
    body: [
      ...
      "Board fills: AA Sol 48 / Luna 37 (22 Sep, Artificial Analysis); Arena+ Sol 1509 (22 Sep, OpenLM); Vals Terminal-Bench 2.1 Sol 83.15 and Luna 73.03 (23 Sep, max effort). Luna Arena, CursorBench for both, and SWE stay blank. DeepSWE and AutomationBench are not Ridge columns.",
...

  {
    id: "vals-grok47-0921",
    kind: "ranking",
    title: "Vals Grok 4.7: Index slips vs 4.6; TB 2.1 fills at 76.03",
    dek: "Vals suite eval (xhigh). Index 54.15 (#24/59), down from Grok 4.6 at 59.17. Legal/medical strength. Ridge fills Terminal-Bench 2.1 only. SWE stays blank.",
    pull: "Fill terminal-bench 76.03 from vals.ai asOf 2026-09-21 (xhigh, #14 of 67). Do not paste Vals Index into AA / Arena / CB. Leave swe blank.",
    summary:
    ...
    body: [
      ...
      "Vals Index: #24 of 59 at 54.15% (~54.2% on the X post). Grok 4.6 sits at 59.17% on the same Index; Grok 4.5 at 51.53%. That is a suite composite from Vals, not Artificial Analysis Intelligence Index, not Arena Elo, and not CursorBench 4.0. Do not overwrite those Ridge seats with 54.15.",
      ...
      "Board action: Ridge Terminal-Bench is Terminal-Bench 2.1, so fill grok-4.7 terminal-bench at 76.03, source Vals AI, URL https://vals.ai/, asOf 2026-09-21, note xhigh / #14 of 67 / Terminal-Bench 2.1. Existing AA / Arena / CursorBench seats for Grok 4.7 stay as previously sourced (46 / 1507 / 46.3).",
      "SWE-bench Verified: leave blank. Vals SWE page (updated 1 September 2026) says the bench is saturated and they no longer run new model releases; prior results are preserved. The Grok 4.7 homepage bullets omit SWE-bench Verified. Grok 4.6 keeps its prior Vals SWE 95.6 row. Blanks beat guesses.",
      "Caveat for readers: Vals Index regression vs 4.6 is a Vals story. Ridge AA (46 high), Arena (1507), and CursorBench (46.3 xhigh) are separate instruments. A lower Vals Index does not rewrite those cells. Follow-up desk to the launch note grok-47-0921.",
    ],
  },
...

  {
    ...
    dek: "SpaceXAI posted the cut on 21 Sep. $2/$6 holds. Artificial Analysis publishes AA 46 high; Arena+ now lists Elo 1507; Cursor.com confirms CursorBench 46.3 xhigh. Later Vals fills Terminal-Bench 2.1 at 76.03; SWE stays blank.",
    pull: "Add the sourced AA, Arena+, and Cursor.com rows. Vals later fills Terminal-Bench 2.1 (see vals-grok47-0921). Vals has no new SWE-bench run; do not paste the remaining launch-chart cells onto the board. Blanks beat guesses.",
    summary:
      "21 September 2026: SpaceXAI announces Grok 4.7 as a notable improvement over Grok 4.6 at the same price and speed. Artificial Analysis now lists AA Intelligence Index 46 high (xhigh also 46), OpenLM's Arena+ table lists Elo 1507, and Cursor.com publishes CursorBench 4.0 at 46.3% xhigh / Extra High. Catalog adds AA, Arena+, and Cursor.com rows; a same-day Vals suite eval later fills Terminal-Bench 2.1 at 76.03 (see vals-grok47-0921). Vals SWE-bench has no new run for Grok 4.7 and remains blank. The Cursor.com chart confirms the launch chart's CursorBench cell; the other vendor cells remain context, not Ridge score sources.",
    date: "2026-09-21",
