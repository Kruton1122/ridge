...
export const NEWS: NewsItem[] = [
  {
    ...
    dek: "Sep 12 essay: slow capability gains so safety can keep up. Not a halt. Anthropic commits to embedded evaluators now.",
    pull: "Policy beat, not a board move. If pacing sticks, cadence stories slow; evaluators mean more incident notes, not AA points. Musk agreeing while xAI still races Grok 4.7 is the tension.",
    summary:
      "12 September: Dario Amodei argues for pacing frontier capability so alignment and eval can catch RSI and agent-swarm risk. Musk quote-tweets: \"Dario is right.\" Anthropic goes first on embedded third-party evaluators; industry and global steps remain the hard part.",
    date: "2026-09-12",
    ...
    body: [
      "Dario Amodei published We Must Pace the Frontier on 12 September. Same day ~14:01 UTC he pointed at it on X. ~15:01 UTC Elon Musk quote-tweeted the post with exactly: \"Dario is right.\" That is the clear same-day endorsement of this essay. Public lab-CEO pile-on beyond Musk looked thin as of writing.",
      ...
      "Who else sits in the same policy neighborhood, earlier and not as same-day cosigns of this essay: Hassabis's mid-2026 FINRA-style frontier oversight idea drew praise from Sam Altman (\"thoughtful\"), Musk (\"good starting point\"), Satya Nadella, and Jack Clark (\"excellent\"). Those people have been converging on third-party / coordinated frontier oversight. Do not read that as everyone posting \"I agree with We Must Pace the Frontier\" today.",
      "Ridge angle: no catalog edits, no SNAPSHOT bump. If pacing sticks, release cadence and who-ships-first stories slow. Embedded evaluators mean more incident transparency that may show up as methodology or trust notes, not AA numbers. Anthropic's unilateral step is real. Steps 2-3 are where rivals can still defect. Musk saying Dario is right while xAI still races Grok 4.7 is the headline weirdness. Hold both facts.",
    ],
  },
  {
    id: "grok-47-cook",
