...
export const SNAPSHOT_LABEL = "21 September 2026";
...
export const MODELS: Model[] = [
  m({
    ...
    publicOpinionNote: 'Still the coding/prose daily driver and the open-ended seat vs Astra; weekly limits block a 5. Fable 5.2 is rumor. (Grok Build X, 2026-09-21)',
  ...
  m({
    ...
    publicOpinionNote: 'Still the Fable-quota overflow; this window heat is a WSJ Opus-assisted OpenAI break-in story, base-model darkness, and an unshipped 5.5 rumor. (Grok Build X, 2026-09-21)',
    publicOpinionAsOf: "2026-09-21",
  }),
  m({
    id: "claude-fable-5",
  ...
  m({
    ...
    status: "ga",
    publicOpinionStars: 4,
    publicOpinionNote: 'OpenCode/Muse-Code cheap daily coder that talks normally; this window Meta volume is Muse Mac/connectors, not a max-vs-xhigh split. (Grok Build X, 2026-09-21)',
    publicOpinionAsOf: "2026-09-21",
  }),
  m({
  ...
  m({
    ...
    publicOpinionStars: 4,
    publicOpinionNote: 'Still the computer-use/3D step-change and the default frontier name; quota plus wait-until-the-spec-is-complete keep it off 5. (Grok Build X, 2026-09-21)',
    publicOpinionAsOf: "2026-09-21",
  }),
  m({
    id: "gpt-5.6-sol",
    ...
    publicOpinionStars: 3,
    publicOpinionNote: 'Respectable leftover; thin new 5.6 verdict this window. Public heat is an unshipped GPT-6 Sol rumor that is not this row. (Grok Build X, 2026-09-21)',
    publicOpinionAsOf: "2026-09-21",
  }),
  m({
    id: "grok-4.7",
  ...
  m({
    ...
    publicOpinionStars: 4,
    publicOpinionNote: 'Still the frontend/open-weight favorite; Cline Desktop free seat this window. Cheap-agent slot is still Flash. K3.1 is rumor. (Grok Build X, 2026-09-21)',
    publicOpinionAsOf: "2026-09-21",
  }),
  m({
    id: "glm-5.3",
  ...
  m({
    ...
    publicOpinionStars: 3,
    publicOpinionNote: 'Fast cheap Copilot/coding bargain still; this window Google volume is Irregular breakout + leftover 3.8 Live + Gemini 4 rumor, not a Flash love wave. (Grok Build X, 2026-09-21)',
    publicOpinionAsOf: "2026-09-21",
  }),
  m({
    id: "qwen-3.8-max",
  ...
  m({
    ...
    publicOpinionStars: 4,
    publicOpinionNote: 'Still the viral cheap agent worker and Codex-quota escape hatch; this window is leftover, not a new capability consensus. (Grok Build X, 2026-09-21)',
    publicOpinionAsOf: "2026-09-21",
  }),
  m({
    id: "deepseek-v4-pro",
...
export const SCORES: Score[] = [
  ...
  s("glm-5.3", "aa-intelligence", 45, "Artificial Analysis", "https://artificialanalysis.ai/leaderboards/models", "2026-09-21", "best effort/variant: max"),
  s("gpt-5.6-terra", "aa-intelligence", 42, "Artificial Analysis", "https://artificialanalysis.ai/leaderboards/models", "2026-09-21", "best effort/variant: max"),
  s("qwen-3.8-max", "aa-intelligence", 45, "Artificial Analysis", "https://artificialanalysis.ai/leaderboards/models", "2026-09-21", "best effort/variant: 0902"),
  ...
  s("gpt-5.6-terra", "arena-elo", 1505, "Arena+", "https://openlm.ai/chatbot-arena/", "2026-09-21"),
  s("grok-4.5", "arena-elo", 1504, "Arena+", "https://openlm.ai/chatbot-arena/", "2026-09-21"),
  s("gemini-3.1-pro", "arena-elo", 1504, "Arena+", "https://openlm.ai/chatbot-arena/", "2026-09-21"),
  s("gemini-3.7-flash", "arena-elo", 1503, "Arena+", "https://openlm.ai/chatbot-arena/", "2026-09-21"),
  s("gemini-3.8-flash", "arena-elo", 1505, "Arena+", "https://openlm.ai/chatbot-arena/", "2026-09-21", "early listing"),
  s("gpt-6-astra", "arena-elo", 1520, "Arena+", "https://openlm.ai/chatbot-arena/", "2026-09-21"),
  s("muse-spark-1.3", "arena-elo", 1507, "Arena+", "https://openlm.ai/chatbot-arena/", "2026-09-21"),
  s("glm-5.3", "arena-elo", 1505, "Arena+", "https://openlm.ai/chatbot-arena/", "2026-09-21"),
  s("deepseek-v4-pro", "arena-elo", 1502, "Arena+", "https://openlm.ai/chatbot-arena/", "2026-09-21"),
  s("claude-sonnet-5", "arena-elo", 1485, "Arena+", "https://openlm.ai/chatbot-arena/", "2026-09-21", "Arena lists Thinking"),
  s("gpt-5.6-luna", "arena-elo", 1451, "Arena+", "https://openlm.ai/chatbot-arena/", "2026-09-21"),
  s("deepseek-v4.1-flash", "arena-elo", 1503, "Arena+", "https://openlm.ai/chatbot-arena/", "2026-09-21"),

  s("claude-opus-5", "swe-bench", 97, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("deepseek-v4-pro", "swe-bench", 96.4, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("gpt-5.6-sol", "swe-bench", 96.2, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("grok-4.6", "swe-bench", 95.6, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("claude-fable-5", "swe-bench", 95, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("kimi-k3", "swe-bench", 93.4, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("gpt-5.6-luna", "swe-bench", 93, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("qwen-3.8-max", "swe-bench", 85.6, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("grok-4.5", "swe-bench", 86.6, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("gpt-5.6-terra", "swe-bench", 95.4, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("glm-5.3", "swe-bench", 95.4, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("gemini-3.8-flash", "swe-bench", 80, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("gemini-3.7-flash", "swe-bench", 80.8, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("claude-sonnet-5", "swe-bench", 79.6, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21"),
  s("gemini-3.1-pro", "swe-bench", 78.8, "Vals AI", "https://vals.ai/benchmarks/swebench", "2026-09-21", "Vals still labels Preview"),
