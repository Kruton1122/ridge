...
export const MODELS: Model[] = [
  ...
  m({
    ...
    publicOpinionNote: 'Still the Fable-quota overflow. Opus 5.5 shipped 22 Sep; this row stays Opus 5. (Grok Build X + Anthropic, 2026-09-22)',
    publicOpinionAsOf: "2026-09-21",
  }),
  m({
    id: "claude-fable-5",
  ...
  m({
    ...
    publicOpinionStars: 3,
    publicOpinionNote: '5.6 leftover. GPT-6 Sol shipped 22 Sep; do not mix rows. (Grok Build X + OpenAI, 2026-09-22)',
    publicOpinionAsOf: "2026-09-21",
  }),
  m({
    id: "grok-4.7",
